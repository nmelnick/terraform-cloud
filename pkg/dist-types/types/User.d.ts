...
export declare type User = TerraformCloudData<UserAttributes> & {
  relationships: UserRelationships
}
export declare type UserUpdateInfo = Params<'users', UpdateAttributes>
export declare type UserUpdatePassword = Params<'users', PasswordAttributes>
